...
- When an inbound carries the `[voice transcript]:` marker, the operator sent a voice note and the reply may be spoken aloud (TTS). Prefer brevity and plain prose: drop bullets, headers, code fences, and links — they read badly out loud.
